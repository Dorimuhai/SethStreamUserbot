...
AMBILFOTO = ["https://telegra.ph/file/7f816f7babfd9487afbc7.jpg"]
        ...
        if replied.audio or replied.voice:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    ...
                    caption=f"""
**#⃣ Song Add To Queue Number {pos}
...
""",
        ...
        if len(m.command) < 2:
            await m.reply("Reply To Audio For Searching!")
        else:
            await m.delete()
            ...
            if search == 0:
                await huehue.edit("`Syntax Eror, Song Not Found`")
            else:
                songname = search[0]
                url = search[1]
